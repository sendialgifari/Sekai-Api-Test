                            ...
                            <div class="col-lg-12">
                                <div class="p-5">
                                    <div class="text-center mb-5">
                                        <h1 class="h4 text-gray-900 mb-4"><img src="/images/logo.png" style="width: 250px;" /></h1>
                                    </div>
                                    <form method="POST" class="user" action="{{ route('login') }}">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <span toggle="#password" class="fa fa-fw fa-eye field-icon toggle-password"
                                                style="float: right;margin-left: -25px;margin-top: -32px;position: relative;z-index: 2;margin-right: 20px;"></span>
                                        ...
                                        <button type="submit" class="mb-5 btn btn-primary btn-user btn-block">
                                            Login
                                        </button>
                                    </form>
                                </div>
